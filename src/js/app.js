        ...
        const frontpageNavigation = document.querySelector(".frontpage-navigation");
        ...
        function displayItemDetails(item) {
            ...
            const backButtonAdele = document.createElement("button");
            ...
            backButtonAdele.className = "back-button-adele";
            backButtonAdele.innerText = "Back";
            backButtonAdele.addEventListener("click", displayGalleryAdele); 
